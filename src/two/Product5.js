            ...
            <div class='w-100 d-flex'>
                <div class='productInformation w-50 ps-4'>
                  ...
                  <div class='d-flex mt-4 pt-4'>
                    ...
                    {isAlertVisible && <div class='alertBox position-absolute w-25 h-25 bg-light text-center'>
                            <h1>Produkt tillagd!</h1>
                            <Link to='/two/cart'><Button size='lg' className='mt-4'>Till varukorgen</Button></Link>
                            <Button size='lg' className='mt-4 ms-2 bg-secondary' onClick={() => setIsAlertVisible(false)}>Fortsätt handla</Button>
                        </div>}
                  </div>
                </div>
