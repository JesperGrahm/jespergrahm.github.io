            ...
            <div class='w-100 d-flex'>
                ...
                <div class='productInformation w-50 ps-4'>
                  ...
                  <div class='d-flex mt-4 pt-4'>
                    <Button size='lg' onClick={() => setIsAlertVisible(true)}>Lägg i varukorg</Button>
                    {isAlertVisible && <div class='alertBox2 position-absolute w-25 h-25 bg-light text-center'>
                            <h1>Lägg till i varukorg</h1>
                    <div class='w-75 d-flex ms-4'>
                        ...
                        <div class='d-flex mt-4 pt-2 ms-4'>
                            <div className='w-25'>
